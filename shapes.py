...
def shape2(center_x, center_y):
    ...
    vertex1 = [center_x, center_y + 20]
    vertex2 = [center_x + 1, center_y + 8]
    vertex3 = [center_x + 6, center_y + 4]
    vertex4 = [center_x + 6, center_y + 12]
    vertex5 = [center_x + 10, center_y]
    vertex6 = [center_x + 6, center_y - 10]
    vertex7 = [center_x + 6, center_y - 40/6]
    vertex8 = [center_x + 4, center_y - 40/6]
    vertex9 = [center_x, center_y - 6]
    vertex10 = [center_x - 4, center_y - 40/6]
    vertex11 = [center_x - 6, center_y - 40/6]
    vertex12 = [center_x - 6, center_y - 10]
    vertex13 = [center_x - 10, center_y]
    vertex14 = [center_x - 6, center_y + 12]
    vertex15 = [center_x - 6, center_y + 4]
    vertex16 = [center_x - 1, center_y + 8]
